...
int initMat34(OsqpEigen::Solver& solver)
{
   ...
   /* hessian << 1, -1, 1,
    ...
    Eigen::Vector3d warm_start = {-8.06284e-09, 0.5, -5.26157e-09};
    solver.setPrimalVariable(warm_start);
...
int main() {
    ...
    cout << solver.isInitialized() << endl;
