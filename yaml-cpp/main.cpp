...
// int dim_x = 100, dim_y = 300;
// double resolution = 0.01;
// const std::string path = "test.yaml";

// int main(){
//     const auto origin = std::vector<double>{x_min, y_min};
//     const auto dim = std::vector<int>{dim_x, dim_y};
//     YAML::Emitter out;
...
//     out << YAML::Key << "res" << YAML::Value << YAML::Flow << resolution;
//     //out << YAML::Key << "data" << YAML::Value << YAML::Flow << data;
//     out << YAML::EndMap;
//     out << YAML::EndSeq;
